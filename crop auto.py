...
loan=pd.read_csv("E:\\akshay\\Data Science project\\train89.csv")
...
df = pd.read_csv('E:\\akshay\\datasets\\cropdata1.csv')
...
btn=Button(root,text="RECOMMENDED CROP!",bg="blue",fg="white",width=20,height=2, command=page).place(x=460,y=400)
root.mainloop()
